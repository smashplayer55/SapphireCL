        ...
        if string.find(text, 'p#') then
            for i = 6, 1, -1 do
                ...
                if i <= #t then
                    ...
                    pokeBarWindow:getChildById('L'..i):setColor("#e8c05e")
					pokeBarWindow:getChildById('L'..i):setFont("terminus-10px")
...
function lifeBarAtual(i, hp)
    ...
    if tonumber(hp) == 0 then
        pokeBarWindow:getChildById('HP'..i):setText("")
...
function receive(i, name, hp, boost)
	...
	pokeBarWindow:getChildById('B'..i):setFont("terminus-10px")
    pokeBarWindow:getChildById('HP'..i):setBackgroundColor("#ff0000")
    if tonumber(hp) == 0 then
        pokeBarWindow:getChildById('HP'..i):setText("")
        pokeBarWindow:getChildById('HP'..i):setPercent(100);
