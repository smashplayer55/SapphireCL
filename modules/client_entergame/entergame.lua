...
EnterGame.setUniqueServer(server, 7171, 854, 351, 367)
end
...
function youtube()
  ...
  local acceptFunc = function()
    os.execute("start https://www.youtube.com/channel/UCgJHPztxiFFpWGUI9ty3xJA?view_as=subscriber")
  ...
  acceptWindow = displayGeneralBox(tr('Youtube'), tr("Deseja acessar nosso canal no Youtube?"),
...
function facebook()
  ...
  local acceptFunc = function()
    os.execute("start https://www.facebook.com/PokeZRingOnline")
	acceptWindow:destroy()
	acceptWindow = nil
  end
  ...
  acceptWindow = displayGeneralBox(tr('Fã Page Facebook'), tr("Deseja acessar nossa fã page no Facebook?"),
  { { text=tr('Yes'), callback=acceptFunc },
    { text=tr('No'), callback=cancelFunc },
    anchor=AnchorHorizontalCenter }, acceptFunc, cancelFunc)
  return true
...
function discordsite()
  if acceptWindow then
    return true
  end

  local acceptFunc = function()
    os.execute("start https://discord.gg/5rWrD4k")
	acceptWindow:destroy()
	acceptWindow = nil
  end
  ...
  acceptWindow = displayGeneralBox(tr('Discord'), tr("Deseja fazer parte de nossa comunidade no Discord?"),
  { { text=tr('Yes'), callback=acceptFunc },
    { text=tr('No'), callback=cancelFunc },
    anchor=AnchorHorizontalCenter }, acceptFunc, cancelFunc)
  return true
...
function Instagram()
  ...
  local acceptFunc = function()
    os.execute("start https://www.instagram.com/pzroficial")
	acceptWindow:destroy()
	acceptWindow = nil
  end
  ...
  acceptWindow = displayGeneralBox(tr('Instagram'), tr("Deseja acessar nosso INSTAGRAM\n            Para mais noticias?"),
  { { text=tr('Yes'), callback=acceptFunc },
    { text=tr('No'), callback=cancelFunc },
    anchor=AnchorHorizontalCenter }, acceptFunc, cancelFunc)
  return true
...
function Site()
  ...
  local acceptFunc = function()
    os.execute("start https://www.pokezring.com.br")
	acceptWindow:destroy()
	acceptWindow = nil
  end
  ...
  acceptWindow = displayGeneralBox(tr('Site PokeZring'), tr("Deseja acessar nosso Site Oficial?"),
  { { text=tr('Yes'), callback=acceptFunc },
    { text=tr('No'), callback=cancelFunc },
    anchor=AnchorHorizontalCenter }, acceptFunc, cancelFunc)
  return true
...
function recuperarconta()
  ...
  local acceptFunc = function()
    os.execute("start http://www.pokezring.com.br/recovery.php")
	acceptWindow:destroy()
	acceptWindow = nil
  end
  ...
  acceptWindow = displayGeneralBox(tr('Esqueci Minha Senha'), tr("Deseja ir para o nosso site para recuperar sua Conta ?"),
  { { text=tr('Yes'), callback=acceptFunc },
    { text=tr('No'), callback=cancelFunc },
    anchor=AnchorHorizontalCenter }, acceptFunc, cancelFunc)
  return true
...
function criarconta()
  ...
  local acceptFunc = function()
    os.execute("start http://www.pokezring.com.br/register.php")
	acceptWindow:destroy()
	acceptWindow = nil
  end
  ...
  acceptWindow = displayGeneralBox(tr('Criar Conta'), tr("Deseja ir para o nosso site para criar uma Conta ?"),
  { { text=tr('Yes'), callback=acceptFunc },
    { text=tr('No'), callback=cancelFunc },
    anchor=AnchorHorizontalCenter }, acceptFunc, cancelFunc)
  return true
